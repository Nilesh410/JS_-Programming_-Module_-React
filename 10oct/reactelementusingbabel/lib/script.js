...
//         <h2 className="subheadings" id="subheading1">Itview Solution</h2>
//         <p className="paragraphs" id="para1">
...
//           style={{width: 200, background:'red', borderColor:'red'}}></img>

//       </section>
//       <section className="sections" id="section2">
//         <h2 className="subheadings" id="subheading2">Login Details</h2>
//         <label className="labels" id="l1" htmlFor="username" autoComplete='on'>UserName</label
//         ><input className="textfield" id="textfield1" /><label
//           className="labels"
//           id="l2"
//           htmlFor="password"
//           >PassWord</label
//         ><input className="textfield" id="textfield2" type="password" autoComplete="off" /><button
//           className="buttons"
//           id="b1"
//           type="submit"
//         >
...
//     </div>
//   )
const username = 'Itview';
const container = /*#__PURE__*/React.createElement("h2", null, "Technology ", 2 + 3);
